...
cvars.AddChangeCallback( "karmabet_language", function ( convar, oldValue, newValue )
	newValue = string.lower( newValue )
	
	-- Check if new language is actually german
	if newValue ~= "german" then return end
	loadLanguage()
	
	-- Only execute this once
	cvars.RemoveChangeCallback( "karmabet_language", "karmabet_language_cvarchange" )
end, "karmabet_language_cvarchange")